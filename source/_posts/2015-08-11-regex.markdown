...
**tldr = "Hip Hop, Foo-Tang Clan, and two methods—gsub and regular expressions."**
...
I'm two weeks into Flatiron School Web Immersive, and one of our instructors, Steven Nunez aka "Hostile Developer", is introducing  Regular Expressions to a room full of soon to be Master Programmers. Steven ceremoniously named our cohort "Foo-Tang Clan." Note, we were initially named "web_0715." Foo-Tang Clan is a significant improvement, one that signals we've tapped into the larger Hiphop consciousness. It also makes me very happy. I grew up on on Jersey St, in the Borough of Staten Island *aka* Shaolin. The serendipity is => :awesome.
...
With that said, Steven introduces "Regular Expressions", and I begin parallel processing.
...
RIP Lorraine Brown, Rolando Hernandez, Illiana Rodriquez, Sandy Brock, Brook Stephenson, Martha Glinski and Duane Bellamy.

All of you have very squarely supported my intention to realize the promise.
Here's to searching for every opportunity to /grow|with|love/im
