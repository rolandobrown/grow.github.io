...
I'm two weeks into Flatiron School Web Immersive, and one of our instructors, Steven Nunez aka "Hostile Developer", is introducing  Regular Expressions to a room full of soon to be Master Programmers. Last week, Steven ceremoniously named our cohort "Foo-Tang Clan." Note, we were initially named "web_0715."" That's a significant improvement. An improvement that signals we've tapped into the larger Hiphop consciousness.

During this afternoon lecture, Steven's blessing us with a lesson and I'm naturally thinking about Hiphop, and something called "Slang Expressions." Before I explain Regular Expressions, let me explain Slang Expressions so that you get a gist of the mental rinse and repeat I went through to while listening to his lecture.
...
So, Steven introduces "Regular Expressions", and I'm parallel processing. "So far, we've been talking Classes, Methods, and RSpec..." Which reminds me of RESPECT. How do you respect code that can't pass a behavior-driven development test (BDD)?
...
Now, this might seem like a distraction, but trust me, it's not. It's not a rabbit hole or a rant. It's a deeply nuanced critical connection between two bodies of knowledge. It's me bridging the gap between two forms of expression. Both intended to communicate, transform and normalize a set of behaviors. Right? I can't help but do this. So, rather than waste brain cycles fighting my nature, I decided to lean into it.

This "can't help but lean in," better described as "can't stop won't stop" is a manifestation of two personal habits: reconciling languages and seeking the internalization of knowledge. It's also the result of a larger cultural phenomena I imagine both Programmers and Hiphoppas share: the desire to do the Knowledge.

Why does one "do the Knowledge" before we talk about the gsub and the Regular Expression?
Well, because in Hip Hop Culture, we always do the Knowledge first.

In Hip Hop, you do the knowledge to gain access to the essence. That essence is a superpower: the ability to fully express yourself.
In Programming, you do the knowledge to gain access to the essence. That essence is a superpower: the ability to fully express yourself.

I'd like to learn to express myself over time at a higher and higher level of abstraction.

{% gist fc4fbbc44873d145b926 dotheknowledge.rb %}

So here's a few lessons learned on my road to being fully expressed as a Master Programmer, and an invitation to learn more about Hiphop.
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/88jr9QUxbcs" frameborder="0" allowfullscreen></iframe>

#Side A: gsub & Regular Expressions
...
More like these types of characters:
...
- Text you &hearts;. Poems, Songs, Speeches, etc.). Find patterns with RegExr
...
#Side B: Knowing when to use Regular Expressions
...
Here are a few ideas that came to mind reading this quote.

In other words, this is how grow.rb thinks about the relationship between Jamie Zawinski & Jay-Z

<iframe src="//slides.com/rolandobrown/deck/embed" width="700" height="500" scrolling="no" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>

**Ok, now that this is done. Here's how I used the following regular expressions:**
...
- [Jeff Atwood, Two Problems](http://blog.codinghorror.com/regular-expressions-now-you-have-two-problems)
...
- [George Tootheman](http://web0715.students.flatironschool.com/students/george_toothman.html)
...
- [KRS-One on Hiphop conciousness](https://youtu.be/REpSdgORU5A?t=1h5m19s)
